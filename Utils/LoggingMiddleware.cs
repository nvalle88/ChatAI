...
public class LoggingMiddleware
{
    ...
    public async Task InvokeAsync(HttpContext context)
    {
        ...
        try
        {
            ...
            requestTelemetry.Properties["RequestBody"] = Truncate(requestBody, 2000);
            requestTelemetry.Properties["QueryString"] = context.Request.QueryString.ToString();
            requestTelemetry.Properties["ResponseBody"] = Truncate(responseBody, 2000);
        ...
        catch (Exception ex)
        {
            ...
            failedRequestTelemetry.Properties["RequestBody"] = Truncate(requestBody, 2000);
            failedRequestTelemetry.Properties["QueryString"] = context.Request.QueryString.ToString();
            failedRequestTelemetry.Properties["ResponseBody"] = Truncate(ex.ToString(), 2000);
